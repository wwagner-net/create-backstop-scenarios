...
### Added
- GUI: third URL-collection mode ("Eigene URL-Liste") in Step 2 — paste a manual list of URLs directly into a textarea instead of crawling or parsing a sitemap, useful for testing only a specific subset of pages
